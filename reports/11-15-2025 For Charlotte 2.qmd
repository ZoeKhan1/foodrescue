...
# column name didn't load correctly, had to fix that
colnames(raw_food2)[colnames(raw_food2) == "Duration..in.seconds."] <- "Duration (in seconds)"

# Clean data
df <- clean_food2(raw_food2)
